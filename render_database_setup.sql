-- =====================================================
-- MATIX LIVREUR - DATABASE SETUP FOR RENDER
-- =====================================================
...
-- Note: Date-based queries will use the created_at timestamp index efficiently
...
-- GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO your_render_user;
