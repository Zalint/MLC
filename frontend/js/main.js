...
class SubscriptionManager {
          ...
          <div class="subscription-header">
            ...
            <div class="subscription-actions">
              ...
              <button class="btn btn-sm whatsapp-subscription-card-btn"
                      data-subscription-id="${subscription.id}"
                      style="background:#25D366;color:white;border:none;display:inline-flex;align-items:center;justify-content:center;"
  ...
  static sendWhatsAppToSubscription(subscriptionId) {
    ...
    if (sub.remaining_deliveries > 0 && sub.remaining_deliveries < 3) {
      message += `⚠️ *Attention : il ne vous reste que ${sub.remaining_deliveries} livraison${sub.remaining_deliveries > 1 ? 's' : ''}. Pensez a renouveler votre carte !*\n\n`;
      ...
      whatsappBtn.addEventListener('click', () => {
        ...
        const sendTo = (phoneRaw) => {
          ...
          if (remaining > 0 && remaining < 3) {
            message += `⚠️ *Attention : il ne vous reste que ${remaining} livraison${remaining > 1 ? 's' : ''}. Pensez a renouveler votre carte !*\n\n`;
          } else if (remaining === 0) {
            message += `⚠️ *Votre abonnement est epuise. Contactez-nous pour renouveler.*\n\n`;
          }
          message += `Merci de votre confiance !`;
